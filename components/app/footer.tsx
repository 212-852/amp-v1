...
function FooterShape() {
  return (
    ...
    >
      <path
        d="M0 40C39 21 83 18 122 33C140 40 149 50 160 53C168 55 174 52 180 48C186 44 191 45 195 51C199 45 204 44 210 48C216 52 222 55 230 53C241 50 250 40 268 33C307 18 351 21 390 40V186H0V40Z"
        fill="currentColor"
      />
    </svg>
  )
