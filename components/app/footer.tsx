...
function FooterShape() {
  return (
    ...
    >
      <path
        d="M0 40C42 21 82 22 112 42C124 50 131 61 142 63C154 65 162 55 156 43C151 33 158 26 169 31C185 38 190 50 195 58C205 45 220 37 238 38C257 39 274 50 292 49C308 48 318 39 315 31C312 22 301 22 297 30C294 37 301 42 309 38C325 30 347 25 390 40V186H0V40Z"
        fill="currentColor"
      />
    </svg>
  )
