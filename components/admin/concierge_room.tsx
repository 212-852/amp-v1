...
export default function AdminConciergeRoom({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col [--chat-input-height:80px] [--chat-message-bottom-padding:calc(var(--chat-input-height)+24px+env(safe-area-inset-bottom,0px))]">
      <RoomHeader
